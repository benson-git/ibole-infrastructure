...
import com.github.ibole.infrastructure.web.exception.ErrorMessage;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected final ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    final ApiError apiError = message(HttpStatus.BAD_REQUEST, ex, dto);
    return handleExceptionInternal(ex, apiError, headers, HttpStatus.BAD_REQUEST, request);
  }
  ...
  public final ResponseEntity<Object> handleBadRequest(final ConstraintViolationException ex,
    ...
    final ApiError apiError = message(HttpStatus.UNPROCESSABLE_ENTITY, ex, dto);
    return handleExceptionInternal(ex, apiError, new HttpHeaders(), HttpStatus.UNPROCESSABLE_ENTITY,
        request);
  }
  ...
  public ResponseEntity<Object> handleUnauthorization(final UnauthorizedException ex,
    ...
    return handleExceptionInternal(ex, apiError, new HttpHeaders(), HttpStatus.UNAUTHORIZED,
        request);
  }
  ...
  private ApiError message(final HttpStatus httpStatus, final Exception ex,
    ...
    return new ApiError(new ErrorMessage(httpStatus.value(), message, devMessage, validationError));
  }
